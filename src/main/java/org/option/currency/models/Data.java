...
public class Data {
	...
	public String getPremiumTurnOver() {
		return premiumTurnOver;
	}

	public void setPremiumTurnOver(String premiumTurnOver) {
	...
	public String getClientWisePositionLimits() {
		return clientWisePositionLimits;
	}

	public void setClientWisePositionLimits(String clientWisePositionLimits) {
	...
	public String getDailyVolatility() {
		return dailyVolatility;
	}

	public void setDailyVolatility(String dailyVolatility) {
	...
	public String getMarketWidePositionLimits() {
		return marketWidePositionLimits;
	}

	public void setMarketWidePositionLimits(String marketWidePositionLimits) {
	...
	public String getTurnoverinRsLakhs() {
		return turnoverinRsLakhs;
	}

	public void setTurnoverinRsLakhs(String turnoverinRsLakhs) {
		this.turnoverinRsLakhs = turnoverinRsLakhs;
	}

	public String getPchangeinOpenInterest() {
		return pchangeinOpenInterest;
	}

	public void setPchangeinOpenInterest(String pchangeinOpenInterest) {
