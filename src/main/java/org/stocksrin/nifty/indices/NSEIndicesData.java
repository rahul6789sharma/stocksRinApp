...
public class NSEIndicesData {
	...
	public String toString() {
		return "ClassPojo [preOpen = " + preOpen + " time = " + time + " corrOpen = " + corrOpen + " status = " + status + " haltedStatus = " + haltedStatus + " mktOpen = " + mktOpen + " data = "
				+ data + " code = " + code + " preClose = " + preClose + " corrClose = " + corrClose + " mktClose = " + mktClose + "]";
	}
}